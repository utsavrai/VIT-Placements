    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
        <div class="container">
            ...
            <div class="navbar-header">
                <a class="navbar-brand" href="home.php">VIT<span style="color:darkorange;">Forum</span></a>
            </div>
            ...
            <div> 
                <form method="POST" action="question-function.php">
                        ...
                        <select name="category" class="form-control">
                            <option></option>
                            <option value="Programming">Placement</option>
                            <option value="Multimedia">Intership</option>
                            <option value="Computer Networking">Scholarship</option>
                        </select>
