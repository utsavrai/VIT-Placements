// Load the Visualization API and the corechart package.
      ...
      function drawChart1() {
        ...
        // Set chart options
        var options = {title:'Highest & Average package of Batch 2010-14',
                       width:550,
                       height:350,
      ...
      ['Company', 'Number of students'],
         ['Amazon',45],            // RGB value
         ['Oracle', 7],            // English color name
         ['IBM', 56],
         ['Schneider Electrics', 34],
         ['Microsoft', 89], // CSS-style declaration
         ]);

    var newData = google.visualization.arrayToDataTable([
      ['Company', 'Number of students'],
         ['Amazon',56],            // RGB value
         ['Oracle', 8],            // English color name
         ['IBM', 49],
         ['Hyundai', 43],
         ['Schneider Electrics', 78], // CSS-style declaration
         ]);
